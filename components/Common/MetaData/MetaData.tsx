...
const MetaData: React.FunctionComponent = () => (
  <div>
    ...
    <link rel="android-chrome-icon" sizes="36x36" href="/android-chrome-36x36.png" />
    <link rel="android-chrome-icon" sizes="48x48" href="/android-chrome-48x48.png" />
    <link
    ...
    <link rel="android-chrome-icon" sizes="144x144" href="/android-chrome-144x144.png" />
    <link rel="android-chrome-icon" sizes="192x192" href="/android-chrome-192x192.png" />
    <link rel="android-chrome-icon" sizes="384x384" href="/android-chrome-384x384.png" />
    <link rel="android-chrome-icon" sizes="256x265" href="/android-chrome-384x384.png" />
